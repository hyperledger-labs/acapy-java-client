 ...
 */
public class SendPresentationRequestHelper2 {
    ...
    private static Map<String, SendPresentationRequest.IndyRequestedCredsRequestedAttr> buildRequestedAttributes(
        ...
        if (presentationRequest != null && presentationRequest.getRequestedAttributes() != null) {
            ...
            if (attributeGroupNames.size() > result.size()) {
                throw new AriesException(0, "Provided attribute group size does not match the requested size");
            }
        }
        return result;
    }
